 ...
 *
 */
public class CanvasHostSwing extends CanvasHostSwingAbstract {
   ...
   public int getScreenY(int y) {
      //#debug
      toDLog().pBridge("y="+y, this, CanvasHostSwing.class, "getScreenY@118", LVL_05_FINE, true);
   ...
   public int getScreenX(int x) {
      //#debug
      toDLog().pBridge("x="+x, this, CanvasHostSwing.class, "getScreenX@127", LVL_05_FINE, true);
   ...
   public void toString(Dctx dc) {
      dc.root(this, CanvasHostSwing.class, 208);
      toStringPrivate(dc);
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, CanvasHostSwing.class, 228);
      toStringPrivate(dc);
